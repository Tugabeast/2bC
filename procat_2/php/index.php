...
<body>
    ...
    <div id="wrap">
      ...
      <div id="left" class="container col-sm-3" style="border:3px solid #cecece;margin:2%;" onclick="window.location = 'trpovoa.php'">
        ...
        <div align="center">
          ...
          <img class="img-responsive" id="alarmPovoa" src="<?php if ($alarmTrPovoa != 0 || $alarmFusePositivePovoa != 0 || $alarmFuseNegativePovoa != 0 || $alarmFuseUrefPovoa != 0 || $alarmUmaxPovoa != 0 || $alarmImaxPovoa != 0 || $alarmUrefPovoa != 0 || $alarmGPSPovoa != 0) {
                                                              ...
                                                              echo $srcDes;
                                                            } ?>" width="40" height="30"><br><br>
          <p id="dataPovoa">Data: <?php echo $dataPovoa; ?></p>
        </div>

      </div>

      <div id="right" class="container col-sm-3" style="border:3px solid #cecece; margin:2%;" onclick="window.location = 'traveiro.php'">
